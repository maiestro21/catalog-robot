 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Trasabilitate 2.0');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Trasabilitate 2.0');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Trasabilitate 2.0 - Generat automat');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Generat automat\nTrasabilitate 2.0");
